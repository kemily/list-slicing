...
def replace_third_and_last(input_list):
    ...
    """
    #unpacking the list, assigning to the different elements needed numberssS
...
def delete_third_and_seventh(input_list):
    ...
    # to avoid the problems with the list length. When we delete the first number
    # it will shorten the list length, so the indexes will change
    del input_list[6]
